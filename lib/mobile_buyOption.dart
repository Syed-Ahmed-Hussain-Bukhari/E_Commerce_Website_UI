...
class AddToCartMobilePage extends StatefulWidget {
  const AddToCartMobilePage({super.key});

  @override
  State<AddToCartMobilePage> createState() => _AddToCartMobilePageState();
}

class _AddToCartMobilePageState extends State<AddToCartMobilePage> {
  @override
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: SizedBox(
                      ...
                      height: 230,
                      child:Image(image: AssetImage("assets/images/Mobile(1).jpg",),fit:BoxFit.fill),
                    ),
                  ),
                  SizedBox(height: 12,),
...
with cutting edge technologies for a pair.""",style: TextStyle(fontSize: 18,color: Colors.grey,))),
                        ...
                        ListTile(
                          ...
                          subtitle: Text("\$2,000.00",style: TextStyle(fontSize: 18,color: Colors.black,fontWeight: FontWeight.bold),
                                      ),
